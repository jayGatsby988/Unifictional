      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            <div className="text-2xl font-bold bg-gradient-to-r from-gold to-blue bg-clip-text text-transparent mb-4">
              Unifictional
            </div>
            ...
            <ul className="space-y-3">
              {productLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[#6B7280] hover:text-blue transition-colors duration-200 text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            <h3 className="font-semibold text-[#111827] mb-4">Resources</h3>
            <ul className="space-y-3">
