      ...
      <div ref={ref}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
          <motion.div
            ...
            className="bg-red-50 border-2 border-red-200 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8"
          >
            ...
            <ul className="space-y-3 sm:space-y-4">
              {problems.map((problem, i) => (
                ...
                >
                  ...
                  <span className="text-sm sm:text-base text-[#111827]">{problem}</span>
                </motion.li>
              ))}
            </ul>
          </motion.div>
          ...
          <motion.div
            ...
            animate={isInView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="bg-gradient-to-br from-gold-50 to-blue-50 border-2 border-gold-200 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-gold opacity-10 rounded-full -mr-12 sm:-mr-16 -mt-12 sm:-mt-16"></div>
            <div className="relative">
              <div className="flex items-center space-x-2 mb-4 sm:mb-6">
                <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-gradient-to-br from-gold to-blue flex items-center justify-center">
